...
BEGIN_TEST_SUITE(socket_async_ut)
    ...
    TEST_FUNCTION(socket_async_recv_test)
    {
        ...
        for (test_path = TP_RECEIVE_NULL_BUFFER_FAIL; test_path <= TP_RECEIVE_OK; test_path++)
        {
            ...
            // human readability
            test_path_label_output(test_path);
            ...
            case TP_RECEIVE_WAITING_OK:
                ...
                break;
            case TP_RECEIVE_OK:
                NO_FAIL_TEST_PATH(TP_RECEIVE_OK, recv(test_socket, IGNORED_PTR_ARG, IGNORED_NUM_ARG, IGNORED_NUM_ARG));
                break;
            }
    ...
    TEST_FUNCTION(socket_async_send_test)
    {
        ...
        for (test_path = TP_SEND_NULL_BUFFER_FAIL; test_path <= TP_SEND_OK; test_path++)
        {
            ...
            case TP_SEND_OK:
                ...
                NO_FAIL_TEST_PATH(TP_SEND_OK, send(test_socket, IGNORED_PTR_ARG, IGNORED_NUM_ARG, IGNORED_NUM_ARG));
                break;
            }
    ...
    TEST_FUNCTION(socket_async_is_create_complete_test)
    {
        ...
        for (test_path = TP_TCP_IS_COMPLETE_NULL_PARAM_FAIL; test_path <= TP_TCP_IS_COMPLETE_NOT_READY_OK; test_path++)
        {
            ...
            case TP_TCP_IS_COMPLETE_SELECT_FAIL:
                ...
                break;
            case TP_TCP_IS_COMPLETE_ERRSET_FAIL:
                NO_FAIL_TEST_PATH(TP_TCP_IS_COMPLETE_ERRSET_FAIL, select(test_socket + 1, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG));
                break;
            case TP_TCP_IS_COMPLETE_READY_OK:
                NO_FAIL_TEST_PATH(TP_TCP_IS_COMPLETE_READY_OK, select(test_socket + 1, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG));
                break;
            case TP_TCP_IS_COMPLETE_NOT_READY_OK:
                NO_FAIL_TEST_PATH(TP_TCP_IS_COMPLETE_NOT_READY_OK, select(test_socket + 1, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG));
                break;
            }
            ...
            // TP_TCP_IS_COMPLETE_NOT_READY_OK,    // 
            //
            if (test_path >= TP_TCP_IS_COMPLETE_NULL_PARAM_FAIL)
            {
    ...
    TEST_FUNCTION(socket_async_create_tcp_test)
    {
        ...
        for (test_path = TP_TCP_SOCKET_FAIL; test_path <= TP_TCP_CONNECT_SUCCESS; test_path++)
        {
            ...
            init_keep_alive_values();
            bool is_UDP = test_path <= TP_UDP_CONNECT_SUCCESS;
            ...
            // The socket_async_create_tcp test points
            //// Create TCP
            ...
            case TP_TCP_SOCKET_OPT_SET_OK:
                ...
                NO_FAIL_TEST_PATH(TP_TCP_SOCKET_OPT_SET_OK, bind(test_socket, IGNORED_PTR_ARG, IGNORED_NUM_ARG));
                NO_FAIL_TEST_PATH(TP_TCP_SOCKET_OPT_SET_OK, connect(test_socket, IGNORED_PTR_ARG, IGNORED_NUM_ARG));
                break;
            default:
            ...
            if (test_path >= TP_TCP_SOCKET_OPT_0_FAIL && test_path <= TP_TCP_SOCKET_OPT_SET_OK)
            {
    ...
    TEST_FUNCTION(socket_async_create_udp_test)
    {
        ...
        for (test_path = TP_UDP_SOCKET_FAIL; test_path <= TP_UDP_CONNECT_SUCCESS; test_path++)
        {
            ...
            // The socket_async_create_udp test points
            //// Create UDP
            ...
            SOCKET_ASYNC_HANDLE create_result = socket_async_create(0, 0, is_UDP, NULL);
    ...
    // process of testing the tlsio, and reading the test_points.h file first will make the following
    // function make a lot more sense.
    TEST_FUNCTION(socket_async_main_sequence2)
    {

        for (test_path = 0; test_path <= TP_FINAL_OK; test_path++)
        {
            // Show the test point description in the output for the sake of 
            // human readability
            test_path_label_output(test_path);
            ...
            // TP_TCP_CONNECT_SUCCESS,     // socket connect instant success
            //
            if (test_path <= TP_UDP_CONNECT_SUCCESS)
            {
            ...
            // TP_SEND_OK,     
            // 
            if (test_path >= TP_SEND_NULL_BUFFER_FAIL && test_path <= TP_SEND_OK)
            {
                const char *buffer = test_path == TP_SEND_NULL_BUFFER_FAIL ? NULL : test_msg;
                size_t sent_count = BAD_BUFFER_COUNT;
                size_t *sent_count_param = test_path == TP_SEND_NULL_SENT_COUNT_FAIL ? NULL : &sent_count;
            ...
            // TP_RECEIVE_OK,     
            // 
            if (test_path >= TP_RECEIVE_NULL_BUFFER_FAIL && test_path <= TP_RECEIVE_OK)
            {
                char *buffer = test_path == TP_RECEIVE_NULL_BUFFER_FAIL ? NULL : test_msg;
                size_t received_count = BAD_BUFFER_COUNT;
                size_t *received_count_param = test_path == TP_RECEIVE_NULL_RECEIVED_COUNT_FAIL ? NULL : &received_count;
